...
function refreshConfig(){
  if( config.style.fresh ){
    styleConfig = getConfig(true).style
  }
}
...
function Style( page, options ){
  ...
  this.src = page
  this.stylusOptions = merge(styleConfig.stylus, options.stylus || {})
  //options = options || {};
  ...
  this.browsers = options.browsers || styleConfig.browsers
}
...
function minify( options ){
  refreshConfig()
  options = merge(styleConfig.minify, options || {})
