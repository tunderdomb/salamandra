...
function render( page, context ){
  ...
  return function( req, res, next ){
    var renderContext = createContext(page, context)
    console.log("render %s with", page, renderContext)
...
function createContext( page, inlineContext ){
  var pageContext = {}
  try{
  ...
  return merge(globalContext, pageContext, inlineContext)
}
